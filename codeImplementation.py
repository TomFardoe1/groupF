...
if inupdate == 'yes':
    ...
    print("Features to be updated:")
    print("Siri")
    print("Maps")
    print("Battery")
    print("CarPlay")
    updateFeatures() #updates dictionary with new features
else: 
    print("Device has not been updated")
time.sleep(1)
print("")
print("Device:")
print("")
...
removedUserInp = raw_input("Are there any features that should be removed? ")
